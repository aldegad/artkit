...
export default function SpritePanModeToggle() {
  const { isPanLocked, setIsPanLocked } = useEditorTools();
  ...
  return (
    <button
      ...
      title={isPanLocked ? "Touch pan lock ON (touch: pan/zoom only)" : "Touch pan lock OFF"}
    >
