  ...
  return (
    <>
      {open && !isInterpolating && (
        ...
        >
          <p className="text-text-secondary text-sm">{t.frameInterpolationDescription}</p>
          <p className="text-text-tertiary text-xs">Gap: {gapDuration.toFixed(2)}s</p>
          ...
          <p className="text-xs text-text-tertiary">{t.estimatedFrames}: {steps}</p>
        </Modal>
      )}
