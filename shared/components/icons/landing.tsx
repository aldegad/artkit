...
export const LandingVideoIcon: React.FC<IconProps> = ({
  ...
  <svg className={className} viewBox="0 0 48 48" fill="none">
    {/* Track 1 - Video */}
    <rect x="1" y="3" width="32" height="8" rx="2.5" fill="currentColor" opacity={0.4} />
    <rect x="36" y="3" width="11" height="8" rx="2.5" fill="currentColor" opacity={0.25} />

    {/* Track 2 - B-roll */}
    <rect x="7" y="17" width="26" height="7" rx="2.5" fill="currentColor" opacity={0.3} />
    <rect x="36" y="17" width="11" height="7" rx="2.5" fill="currentColor" opacity={0.2} />

    {/* Track 3 - Audio */}
    <rect x="1" y="30" width="34" height="7" rx="2.5" fill="currentColor" opacity={0.2} />

    {/* Playhead */}
    <path d="M27 0l3 4 3-4z" fill="currentColor" opacity={0.8} />
    <line x1="30" y1="3" x2="30" y2="40" stroke="currentColor" strokeWidth={2.5} opacity={0.7} />
