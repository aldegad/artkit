...
const translations: Record<Language, Translations> = {
  ko: {
    ...
    exportTypeOptimizedZip: "레이어 프레임 ZIP (조합용)",
    ...
    exportOptimizedIncludeGuide: "사용 가이드 포함",
  ...
  en: {
    ...
    exportTypeOptimizedZip: "Layered Frames ZIP (Composable)",
    ...
    exportOptimizedIncludeGuide: "Include usage guide",
